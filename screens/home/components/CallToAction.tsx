...
export default function CallToAction() {
  return (
    <section
      ...
      <div className="relative hidden aspect-square overflow-hidden max-[650px]:block">
      ...
      <div className="ml-[160px] w-[min(100%_-_48px,1000px)] max-[1200px]:ml-20 max-[650px]:ml-0 max-[650px]:w-full max-[650px]:bg-[#f8f8f8] max-[650px]:p-5 max-[650px]:py-8">
