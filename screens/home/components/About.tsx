...
export default function About() {
  return (
    <section className="grid grid-cols-2 overflow-hidden rounded-[24px] bg-[#f8f8f8] max-[850px]:grid-cols-1" aria-labelledby="about-title">
      <div className="min-h-[844px] bg-[url('/images/about.png')] bg-cover bg-center max-[1200px]:min-h-[620px] max-[850px]:min-h-[400px]" />
      <div className="flex flex-col justify-center p-[100px] max-[1200px]:p-16 max-[850px]:p-10">
        ...
        <Button className="mt-12 self-start px-7 py-2 uppercase shadow-[0_3px_15px_rgba(0,0,0,.04)]" label="Смотреть каталог" variant="light" href="#catalog" showArrow />
      </div>
    </section>
  );
}
